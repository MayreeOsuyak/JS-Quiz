...
function play(){
    let put
    put = document.getElementById("c").checked;
...
function play2(){
    let put
    put = document.getElementById("e1").checked;
...
function play3(){
    let put
    put = document.getElementById("f3").checked;
...
function play4(){
    let put
    put = document.getElementById("g").checked;
